...
public:
  ...
  explicit TransactionBase(bytesConstRef _rlp, int _checkSig);

    /// Constructs a transaction from the given RLP.
//    explicit TransactionBase(bytes const& _rlp, CheckTransaction _checkSig): TransactionBase(&_rlp, _checkSig) {}
    explicit TransactionBase(bytes const& _rlp, int _checkSig): TransactionBase(&_rlp, _checkSig) {}
